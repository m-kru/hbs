...
ghdl -e ElabArgPrefix --std=08 --workdir=work  -Plib_a -Plib_b -Pwork ElabArgsSuffix TopEntity
./TopEntity SimArgPrefix --wave=TopEntity.ghw  -gGEN=64 --assert-level=error SimArgsSuffix" > golden.txt
