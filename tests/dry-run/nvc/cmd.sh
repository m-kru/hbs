...
nvc ElabArgPrefix --std=2008 -L. -e TopEntity  -g GEN=64 ElabArgsSuffix
nvc SimArgPrefix --std=2008 -L. -r TopEntity --wave --exit-severity=error SimArgsSuffix" > golden.txt
