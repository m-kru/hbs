...
xelab ElabArgPrefix -debug all  -generic_top GEN=64 TopEntity ElabArgSuffix
xsim SimArgPrefix -stats -onerror quit -tclbatch run.tcl TopEntity SimArgSuffix" > golden.txt
